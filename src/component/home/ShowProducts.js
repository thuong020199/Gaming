...
import { dataGame, getProductsa ,getCategories } from '../../connectFirebase/Connect'
...
class ShowProducts extends Component {
  ...
  getProducts = () => {
    var productList = [];
    var i = 0;
    dataGame.ref('products').on('value', (product) => {
  ...
  getCategories = () => {  
    var i=0;
    var categoryList = [];
    dataGame.ref('categories').on('value', (category) => {
